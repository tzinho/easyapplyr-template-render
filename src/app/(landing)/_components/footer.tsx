...
export const Footer = () => {
  return (
    <footer
      className="center relative z-10 pt-16 md:pt-20 lg:pt-24"
      data-wow-delay=".1s"
    >
      <div className="container">
        <div className="flex flex-wrap">
          <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
            <div className="mb-12 flex max-w-[360px] flex-col gap-8 lg:mb-16">
              <Link href="/" className="inline-block">
                <Logo />
              </Link>

              <p className="dark:text-body-color-dark text-body-color text-base leading-relaxed">
                Ajudamos mais de 3000 pessoas a encontrar um novo emprego, de
                forma simples e rápida você cria seu curriculum totalmente
                otimizado pra sua vaga dos sonhos
              </p>

              <Link
                href="/sign-up"
                className="w-fit bg-primary px-8 py-4 text-base font-semibold text-secondary duration-300 ease-in-out"
              >
        ...
        <div className="py-8">
          <p className="text-body-color text-center text-base dark:text-white">
            Copyright &copy; 2025 Easyapplyr. Todos os direitos reservados
          </p>
        </div>
      </div>
    </footer>
